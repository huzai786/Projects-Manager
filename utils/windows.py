...
from utils.utils import generate_project_showcase_layout
...
files = ["notes.txt", "progress.md", "requirements.txt", "main.py"]
...
def main_window():
    ...
    cps_options = [
        ...
        [sg.Listbox(files, key='FILES_TO_CREATE', size=(35, 4), select_mode=sg.SELECT_MODE_MULTIPLE)],
    ...
    ad_layout = [
        ...
        [sg.Button("Edit Project Names", key="EDIT_PROJECT_LAYOUT")]
    ]
    tab_group = [
        [
            sg.TabGroup(
